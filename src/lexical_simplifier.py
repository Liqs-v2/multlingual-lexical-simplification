...
class LexicalSimplifier(metaclass=ABCMeta):
    ...
    def apply_pattern_to(self, original_sentence: str, sentence_with_complex_word_masked: str, topic: str) -> str:
        """
        ...
        Args:
            original_sentence: The original sentence containing the complex word.
            sentence_with_complex_word_masked: The original sentence with the complex word masked.
        ...
        if self.pattern is None or self.pattern == "":
            raise ValueError("Please provide a pattern for this LexicalSimplifier.\n"
                             "A pattern should be a format string that can take the arguments:\n"
                             "original_sentence, sentence_with_complex_word_masked, topic.\n")
    ...
    @abc.abstractmethod
    def generate_substitutions_for(self, complex_word: str, original_sentence: str, topic: str = 'unknown') -> List[str]:
        """
